...
fits = fits.open('/home/antoine/Internship/phangs_sample_table_v1p6.fits')
...
def get_data(muse, gmc_catalog, matching, outliers, gmc_catalog_version, randomize, threshold_perc, vel):
    ...
    galaxias, GMCprop1, HIIprop1, RAgmc, DECgmc, RAhii, DEChii, labsxax, labsyay, idoverhii, idovergmc,a,b = pickle.load(
