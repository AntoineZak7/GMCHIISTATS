...
galaxias, GMCprop1, HIIprop1, RAgmc, DECgmc, RAhii, DEChii, labsxax, labsyay, idoverhiis = pickle.load(
...
HIIprop = GaldisHIIover, SizepcHIIover, LumHacorrover, sigmavHIIover, ratlin, metaliHIIover, varmetHIIover

DisHIIGMCover, MasscoGMCover, SizepcGMCover, Sigmamoleover, sigmavGMCover, aviriaGMCover, TpeakGMCover, \
tauffGMCover, velGMCover,  angleGMCover, majorGMCover, minorGMCover = GMCprop1
...
labsyay = labsyay[0:len(labsyay) - 4] #removing  vel, major axis, minor axis and PA, no need to plot them
...
for i,lab in enumerate(labsyay):
    ...
    pdf1 = fpdf.PdfPages("%sCorrelations_allgals_color-%s_GMC%s.pdf" % (dirplots, shortlab[i],namegmc))  # type: PdfPages
