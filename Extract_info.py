...
def extract_info(gmc_catalog, new_muse, matching, outliers, threshold_perc, vel_limit, randomize):
    ...
    with open((dir_script_data+'Galaxies_variables_notover_GMC%s%s.pickle' % (namegmc, name_end)), "wb") as f:
        pickle.dump([SizepcHII, LumHacorr, sigmavHII, metaliHII, varmetHII, numGMConHII,  FluxCOGMC, HIIminor,
                     HIImajor, HIIangle, angleGMC, majorGMC, minorGMC, MasscoGMC, SizepcGMC, SizepcHII], f)
...
extract_info(gmc_catalog="_native_", new_muse=True, matching="overlap_1om", outliers=True,threshold_perc=0.1 , vel_limit= 10000, randomize = False)
extract_info(gmc_catalog="_native_", new_muse=True, matching="overlap_1om", outliers=True,threshold_perc=0.5 , vel_limit= 10000, randomize = False)
